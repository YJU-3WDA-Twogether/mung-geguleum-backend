...
public enum ErrorCode {
	...
	//User
	,USER_BAD_REQUEST_ERROR(HttpStatus.NOT_FOUND ,"U001" , "존재하지 않는 유저입니다.")
	...
	//Post
	,POST_BAD_REQUEST_ERROR(HttpStatus.NOT_FOUND,"P001", "존재하지 않는 피드 입니다.")
	,POST_NULL_POINT_ERROR(HttpStatus.BAD_REQUEST,"P002" , "삭제된 게시글 입니다.")
	,POST_INTERNAL_SERVER_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "P003", "관리자에게 문의하여 주세요.")
	
	//Log
	,LOG_BAD_REQUEST_ERROR(HttpStatus.NOT_FOUND,"L001","존재하지 않는 로그 입니다.")
