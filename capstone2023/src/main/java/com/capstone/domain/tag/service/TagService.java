package com.capstone.domain.tag.service;
...
public class TagService {
	...
	public List<Object> getTagJson() {
	    List<Object[]> tagList = tagRepository.findAllWithPostAndLog();
	    ...
	    for (Object[] result : tagList) {
	        ...
	        if (!nodeMap.containsKey(pno)) {
	          ...
	          //  postNode.put("pno", pno);
	            ...
	            postNode.put("regTime", post.getRegDate());
...
//	            logNode.put("pno", log.getPost().getPno());
	            ...
	            logNode.put("regTime", log.getPost().getRegDate());
